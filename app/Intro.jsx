...
const Intro = () => {
	const introData = {
		...
		resume: "https://drive.google.com/uc?export=download&id=1LevdCSu8KjueKHenjoMMaREGXmjJqo33",
	};
	return (
		<>
			<div className="mainContainer flex flex-col items-center">
				<Image
					...
					className="w-32 rounded-xl mb-4"
				/>
				<div className="khand text-2xl">
				...
				>
					<div className="flex w-fit space-x-2">
						<Image
							...
							className="w-4"
						/>
						<span className="iceberg text-lg text-green-500">
							Download Resume
						</span>
					</div>
				</Link>
